...
export default function Services() {
  ...
  const services = [
    {
      icon: <svg viewBox="0 0 24 24" fill="none" stroke="#2563EB" strokeWidth="1.8" width="26" height="26"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg>,
      bg: 'rgba(37,99,235,.1)', border: 'rgba(37,99,235,.2)',
    ...
    {
      icon: <svg viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="1.8" width="26" height="26"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg>,
      bg: 'rgba(16,185,129,.1)', border: 'rgba(16,185,129,.2)',
    ...
    {
      icon: <svg viewBox="0 0 24 24" fill="none" stroke="#06B6D4" strokeWidth="1.8" width="26" height="26"><circle cx="12" cy="12" r="3"/><path d="M12 2v3M12 19v3M4.22 4.22l2.12 2.12M17.66 17.66l2.12 2.12M2 12h3M19 12h3M4.22 19.78l2.12-2.12M17.66 6.34l2.12-2.12"/></svg>,
      bg: 'rgba(6,182,212,.1)', border: 'rgba(6,182,212,.2)',
    ...
    {
      icon: <svg viewBox="0 0 24 24" fill="none" stroke="#F59E0B" strokeWidth="1.8" width="26" height="26"><path d="M6 2L3 6v14a2 2 0 002 2h14a2 2 0 002-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 01-8 0"/></svg>,
    ...
    {
      icon: <svg viewBox="0 0 24 24" fill="none" stroke="#8B5CF6" strokeWidth="1.8" width="26" height="26"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg>,
      bg: 'rgba(139,92,246,.1)', border: 'rgba(139,92,246,.2)',
    ...
    {
      icon: <svg viewBox="0 0 24 24" fill="none" stroke="#D97757" strokeWidth="1.8" width="26" height="26"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>,
      bg: 'rgba(217,119,87,.1)', border: 'rgba(217,119,87,.2)',
  ...
  return (
    <section className="brand-section services-section" id="services">
      <div className="brand-container">
        <div className="brand-section-head">
          <span className="brand-tag">{t('خدماتنا', 'Our Services')}</span>
