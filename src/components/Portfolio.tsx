...
const projects = [
  { href: 'https://alhql-aldhky.vercel.app/dashboard', img: '/images/pf-farm.jpg', catAr: 'نظام زراعي ذكي', catEn: 'Smart Farm System', nameAr: 'الحقل الذكي — إدارة المواشي', nameEn: 'Smart Farm — Livestock Management', descAr: 'نظام ذكاء اصطناعي متكامل لإدارة الدواجن والأغنام والأبقار — صحة الحيوان، التغذية، الإنتاج واللقاحات', descEn: 'AI-powered system for managing poultry, sheep & cattle — health monitoring, feeding, production & vaccinations' },
